...
class TensorBoardSummary:
    ...
    def add_losses(self, losses, train_videos):
        tf.summary.scalar('Losses/Discriminator_A', losses.loss_D_a)
        tf.summary.scalar('Losses/Discriminator_B', losses.loss_D_b)
        #if train_videos:
        tf.summary.scalar('Losses/Discriminator_Total', losses.loss_D)
