...
class Losses:
    def __init__(self, networks: Networks, placeholders: Placeholders, images: Images, cycle_loss_coeff, train_videos,
        ...
        self.define_losses(images, cycle_loss_coeff, train_videos, train_images)
    ...
    def define_discriminator_output_video(self, images: Images, networks: Networks, placeholders: Placeholders):
        ...
        self.D_fake_frame_a = networks.discriminator_spatial_a(images.frames_ba[:, 1])
    ...
    def define_losses(self, images: Images, cycle_loss_coeff, train_videos, train_images):
        ...
        self.define_temporal_generator_loss(train_videos)
    ...
    def define_temporal_generator_loss(self, train_videos):
        if train_videos:
    ...
    def define_total_generator_loss(self):
        self.loss_G_ab_final = self.loss_G_spat_ab + 0.4 * self.loss_G_temp_ab + self.loss_cycle
        self.loss_G_ba_final = self.loss_G_spat_ba + 0.4 * self.loss_G_temp_ba + self.loss_cycle
