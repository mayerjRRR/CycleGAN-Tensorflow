...
class Placeholders:
    ...
    def init_fake_history_placeholders(self, batch_size, image_shape):
        ...
        self.history_fake_temp_frames_a = tf.placeholder(tf.float32, [batch_size, frame_sequence_length] + image_shape, name='history_fake_a')
        self.history_fake_temp_frames_b = tf.placeholder(tf.float32, [batch_size, frame_sequence_length] + image_shape, name='history_fake_b')
